...
class spawnpoint extends EventEmitter {
	...
	info(){
		helpers.log({
			...
			line: chalk.white(Reflect.apply(format, this, arguments))
		});
		return this;
	}
	...
	warn(){
		helpers.log({
			...
			line: chalk.yellow(Reflect.apply(format, this, arguments))
		}, 'error');
		return this;
	}
	...
	error(){
		helpers.log({
			...
			line: chalk.red(Reflect.apply(format, this, arguments))
		}, 'error');
		return this;
	}
